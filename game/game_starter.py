...
from game.tichu.agents.icarus_agents import IcarusUTCAgent
...
if __name__ == "__main__":
    ...
    """
    players = [
        TichuPlayer(name="player0", agent=IcarusUTCAgent(), perfect_information_mode=True),
        TichuPlayer(name="player1", agent=RandomAgent(), perfect_information_mode=True),
        TichuPlayer(name="player2", agent=IcarusUTCAgent(), perfect_information_mode=True),
