...
- not trivial to find good groups (I just put the same combination-type into the same groups with the idea that they most of the time lead to similar results.) % TODO NOTE: maybe hight/rank and "probability" are better groups.
